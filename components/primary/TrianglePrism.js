    ...
    <svg width={width} height={height} >
      <defs>
        <filter id="glow" x="-500%" y="-500%" width="1000%" height="1000%">
          <feFlood result="flood" flood-color="#DC00FF" flood-opacity="1"></feFlood>
